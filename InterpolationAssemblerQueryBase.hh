...
#ifndef MACI_INTERPOLATION_ASSEMBLER_QUERY_BASE_HH_INCLUDED
#define MACI_INTERPOLATION_ASSEMBLER_QUERY_BASE_HH_INCLUDED 1
...
class InterpolationAssemblerQueryBase : public pulib::Query<DIM>
{
...
public:
    InterpolationAssemblerQueryBase(ElementShadowList::Iterator element)
