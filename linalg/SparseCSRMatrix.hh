...
#ifndef MACI_LINALG_SPARSE_CSR_MATRIX_HH_INCLUDED
#define MACI_LINALG_SPARSE_CSR_MATRIX_HH_INCLUDED 1
...
namespace linalg 
{
    ...
    /// Sparse Matrix which uses the CSR format to store the matrix. This
    /// implementation does not require any external package to work.
    ...
    public:
        ...
        void SpMV(SpMV_Op op, Tp alpha, Tp* x, Tp beta, Tp* y);
